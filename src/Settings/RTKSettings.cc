...
DECLARE_SETTINGSFACT(RTKSettings, listenRTCM)
DECLARE_SETTINGSFACT(RTKSettings, forwardRTCM)
DECLARE_SETTINGSFACT(RTKSettings, forwardRTCMURI)
DECLARE_SETTINGSFACT(RTKSettings, forwardRTCMAddress)
DECLARE_SETTINGSFACT(RTKSettings, forwardRTCMPort)
